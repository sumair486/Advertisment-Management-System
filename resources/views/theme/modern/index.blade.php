                        ...
                        <div class="search-wrapper">
                            <form class="form-inline" action="{{ route('listing') }}" method="get">
                                <div style="width: 100%" class="form-group">
                                    <input type="text" style="width: 100%"  class="form-control" id="searchTerms" name="q" value="{{ request('q') }}" placeholder="@lang('app.search___')" />
                                </div>
                                ...
                                <button style="margin-top: 20px" type="submit" class="btn theme-btn"> <i class="fa fa-search"></i> Search</button>
                            </form>
                        </div>
            ...
            <div class="col-md-12">
                ...
                <div class="modern-home-cat-wrap">
                    <select  class="form-control"  onchange="location = this.value;">
                        ...
                        @foreach($top_categories as $category)
                            <option class="form-control"  value="{{ route('listing') }}?category={{$category->id}}">
                                {{ $category->category_name }}
                            </option>
                            @if($category->sub_categories->count())
                                @foreach($category->sub_categories as $s_cat)
                                    <option class="form-control"  value="{{ route('listing') }}?category={{$category->id}}&sub_category={{$s_cat->id}}">
                                        &nbsp;&nbsp;&nbsp;&nbsp;{{ $s_cat->category_name }}
                                    </option>
                                @endforeach
                            @endif
